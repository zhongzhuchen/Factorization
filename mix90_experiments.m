...
for s=2:(n-1)
    ...
    exceloutput(end+1,:)=[n, s, info_DDFact.dualbound, info_Linx.dualbound, info_Mix.dualbound,...
        ...
        info_DDFact.fixnum_to0+info_DDFact.fixnum_to1, info_Linx.fixnum_to0+info_Linx.fixnum_to1, info_Mix.fixnum_to0+info_Mix.fixnum_to1,...
        info_Mix.alpha,...
...
title=["n", "s", "dualbound_DDFact", "dualbound_Linx", "dualbound_Mix",...
    ...
    "fixnumto_DDFact", "fixnumto_Linx", "fixnumto_Mix",...
    "Mix_alpha",...
