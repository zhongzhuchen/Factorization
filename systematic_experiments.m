...
%     length(info.nonsmooth_everyiter)
    ...
    [fixto0list,fixto1list] = varfix_Linx(x,s,C,gamma);
    Linxsdpt3_fixto0=length(fixto0list);
    Linxsdpt3_fixto1=length(fixto1list);
    ...
    exceloutput(end+1,:)=[n, s, info_DDFact.exitflag, info_DDFact_comp.exitflag, info_Linx.exitflag, info_Linx_sdpt3.code,...
        ...
        DDFact_fixto0, DDFactcomp_fixto0,Linx_fixto0,Linxsdpt3_fixto0,...
        DDFact_fixto1, DDFactcomp_fixto1,Linx_fixto1,Linxsdpt3_fixto1,...
        DDFact_fixto0+DDFact_fixto1, DDFactcomp_fixto0+DDFactcomp_fixto1,Linx_fixto0+Linx_fixto1,Linxsdpt3_fixto0+Linxsdpt3_fixto1,...
...
title=["n", "s", "dualbound_DDFact_exitflag", "dualbound_DDFact_comp_exitflag", "dualbound_Linx_exitflag", "dualbound_Linxsdpt3_exitflag",...
    ...
    "fixnum0_DDFact", "fixnum0_DDFact_comp", "fixnum0_Linx", "fixnum0_Linx_sdpt3",...
    "fixnum1_DDFact", "fixnum1_DDFact_comp", "fixnum1_Linx", "fixnum1_Linx_sdpt3",...
