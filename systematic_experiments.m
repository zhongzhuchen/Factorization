...
%     length(info.nonsmooth_everyiter)
    ...
    subexceloutput=[n*ones(lengthexcel,1), s*ones(lengthexcel,1), info_DDFact_comp.dualbound_everyiter',...
        info_DDFact_comp.dualgap_everyitr',info_DDFact_comp.normsubg_everyitr',info_DDFact_comp.num_nonsmooth_everyitr'];
    subtitle=["n", "s", "dualbound", "dualgap", "normsubg","prob_nomsmoothpts"];
    ...
    exceloutput(end+1,:)=[n, s, info_DDFact.dualbound, info_DDFact_comp.dualbound, info_Linx.dualbound, info_Linx_sdpt3.dualbound,...
        info_DDFact.dualgap, info_DDFact_comp.dualgap, info_Linx.dualgap, info_Linx_sdpt3.dualgap,...
...
title=["n", "s", "dualbound_DDFact", "dualbound_DDFact_comp", "dualbound_Linx", "dualbound_Linx_sdpt3",...   
    "dualgap_DDFact", "dualgap_DDFact_comp", "dualgap_Linx", "dualgap_Linx_sdpt3",...
